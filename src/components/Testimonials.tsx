...
const testimonials: testimonialsObjectShape[] = [
    {
...
export const Testimonials = () => {
    ...
    const logos = useRef<HTMLDivElement | null>(null)
            ...
            <div className="flex flex-row lg:flex-row gap-[20px] animate-marquee" ref={cards}>
                {testimonials.map((content, index) => (
                    <div key={index} className="bg-[#F8F8F9] min-w-[500px] flex flex-col gap-[40px] p-[40px] rounded-[24px]">
                        <img
                            src="https://ik.imagekit.io/rwgk2b4rf/svgexport-14.svg?updatedAt=1746608985069"
                            className="w-[40px]"
                        />
